...
* **Icons** - Throughout the site there are also some text links, for example on the footer and in the forum pages, which are either in white with an orange hover or orange with a white hover. I did this to try to keep a consistent colour theme throughout the site.
